...
export const Icons = {
  ...
  Pin1: I(<><path d="M2 12C2 6.5 6.5 2 12 2a10 10 0 0 1 8 6"/><path d="M5 19.5C5.5 18 6 15 6 12c0-.7.12-1.37.34-2"/><path d="M17.29 21.02c.12-.6.43-2.3.5-3.02"/><path d="M12 10a2 2 0 0 1 2 2c0 1.02-.1 2.51-.26 4"/><path d="M8.65 22c.21-.66.45-1.32.57-2"/><path d="M14 13.12c0 2.38 0 6.38-1 8.88"/><path d="M2 16.1C2.5 14.56 8.1 9.52 14 10"/><rect x="4" y="9" width="16" height="4" fill="white" stroke="currentColor" strokeWidth="1.5"/><path d="M5.5 11l1.5 1.5M7 11L5.5 12.5M9.5 11l1.5 1.5M11 11L9.5 12.5M13.5 11l1.5 1.5M15 11l-1.5 1.5M17.5 11L19 12.5M19 11l-1.5 1.5" stroke="currentColor" strokeWidth="1.5"/><text x="18" y="21" fontSize="10" fontWeight="bold" fill="currentColor">1</text></>),
  Pin2: I(<><path d="M2 12C2 6.5 6.5 2 12 2a10 10 0 0 1 8 6"/><path d="M5 19.5C5.5 18 6 15 6 12c0-.7.12-1.37.34-2"/><path d="M17.29 21.02c.12-.6.43-2.3.5-3.02"/><path d="M12 10a2 2 0 0 1 2 2c0 1.02-.1 2.51-.26 4"/><path d="M8.65 22c.21-.66.45-1.32.57-2"/><path d="M14 13.12c0 2.38 0 6.38-1 8.88"/><path d="M2 16.1C2.5 14.56 8.1 9.52 14 10"/><rect x="4" y="9" width="16" height="4" fill="white" stroke="currentColor" strokeWidth="1.5"/><path d="M5.5 11l1.5 1.5M7 11L5.5 12.5M9.5 11l1.5 1.5M11 11L9.5 12.5M13.5 11l1.5 1.5M15 11l-1.5 1.5M17.5 11L19 12.5M19 11l-1.5 1.5" stroke="currentColor" strokeWidth="1.5"/><text x="18" y="21" fontSize="10" fontWeight="bold" fill="currentColor">2</text></>),
  PendingUser: I(<><path d="M16 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"/><circle cx="8.5" cy="7" r="4"/><path d="M16 3.13a4 4 0 0 1 0 7.75"/><path d="M21 12c0 5-4 9-9 9"/><polyline points="12 12 16 12 16 8"/></>),
  PermissionsBadge: I(<><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/><circle cx="12" cy="11" r="2"/><path d="M12 13v3"/><circle cx="4" cy="4" r="2"/><circle cx="20" cy="4" r="2"/><circle cx="4" cy="20" r="2"/><circle cx="20" cy="20" r="2"/><path d="M4 6v12"/><path d="M20 6v12"/><path d="M6 4h12"/><path d="M6 20h12"/></>),
  ...
  Safari: I(<><circle cx="12" cy="12" r="10"/><polygon points="12 2 14.5 8.5 12 12 9.5 8.5 12 2" fill="currentColor"/><line x1="12" y1="12" x2="18" y2="18"/></>),
  PlusSquare: I(<><rect x="3" y="3" width="18" height="18" rx="2"/><line x1="12" y1="8" x2="12" y2="16"/><line x1="8" y1="12" x2="16" y2="12"/></>),
  ...
  Delete: I(<><path d="M21 4H8l-7 8 7 8h13a2 2 0 0 0 2-2V6a2 2 0 0 0-2-2z"/><line x1="18" y1="9" x2="12" y2="15"/><line x1="12" y1="9" x2="18" y2="15"/></>),
  EyeOff: I(<><path d="M17.94 17.94A10.07 10.07 0 0 1 12 20c-7 0-11-8-11-8a18.45 18.45 0 0 1 5.06-5.94"/><path d="M9.9 4.24A9.12 9.12 0 0 1 12 4c7 0 11 8 11 8a18.5 18.5 0 0 1-2.16 3.19"/><line x1="1" y1="1" x2="23" y2="23"/></>),
